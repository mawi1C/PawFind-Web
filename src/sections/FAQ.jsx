...
const faqs = [
  ...
  { question: "How accurate is the AI prediction?", answer: "Our model achieves a 98% accuracy rate in determining 'High Probability Zones' by analyzing breed specific behaviors (e.g., Beagles follow scents, Cats hide in silence) against local map data." },
