    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Magnetic>
            <a href="https://github.com/mawi1C/PawFind-Web/releases/download/v1-0/PawFind.apk" download="PawFind.apk" className="flex items-center gap-2 bg-secondary text-white px-6 py-2.5 rounded-xl font-bold text-sm shadow-lg hover:bg-gray-800 transition-all">
              <Download size={16} />
              Download APK
            </a>
          </Magnetic>
